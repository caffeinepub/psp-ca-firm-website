...
export class Backend implements backendInterface {
    ...
    async deleteSubmission(arg0: SubmissionId): Promise<void> {
    ...
    async getSubmissionById(arg0: SubmissionId): Promise<ContactSubmission> {
        if (this.processError) {
            try {
    ...
    async submitContactForm(arg0: FullName, arg1: Email, arg2: PhoneNumber, arg3: ServiceInterest, arg4: Message): Promise<SubmissionId> {
        if (this.processError) {
            try {
